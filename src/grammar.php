...
return [
    ...
    'grammar' => [
        'Boolean' => new \Phplrt\Parser\Grammar\Alternation([154, 155]),
        ...
        'EnumValue' => new \Phplrt\Parser\Grammar\Alternation([138, 141]),
        ...
        'Note' => new \Phplrt\Parser\Grammar\Concatenation([149, 150]),
        ...
        'SettingNote' => new \Phplrt\Parser\Grammar\Concatenation([152, 'String', 153]),
        'String' => new \Phplrt\Parser\Grammar\Alternation([156, 157]),
        ...
        135 => new \Phplrt\Parser\Grammar\Concatenation([142, 'SettingNote', 143]),
        136 => new \Phplrt\Parser\Grammar\Lexeme('T_WORD', true),
        137 => new \Phplrt\Parser\Grammar\Optional(135),
        138 => new \Phplrt\Parser\Grammar\Concatenation([136, 137]),
        139 => new \Phplrt\Parser\Grammar\Lexeme('T_QUOTED_STRING', true),
        140 => new \Phplrt\Parser\Grammar\Optional(135),
        141 => new \Phplrt\Parser\Grammar\Concatenation([139, 140]),
        142 => new \Phplrt\Parser\Grammar\Lexeme('T_LBRACK', false),
        143 => new \Phplrt\Parser\Grammar\Lexeme('T_RBRACK', false),
        144 => new \Phplrt\Parser\Grammar\Lexeme('T_COLON', false),
        145 => new \Phplrt\Parser\Grammar\Concatenation([144, 'String']),
        146 => new \Phplrt\Parser\Grammar\Lexeme('T_LBRACE', false),
        147 => new \Phplrt\Parser\Grammar\Lexeme('T_RBRACE', false),
        148 => new \Phplrt\Parser\Grammar\Concatenation([146, 0, 'String', 147, 0]),
        149 => new \Phplrt\Parser\Grammar\Lexeme('T_NOTE', false),
        150 => new \Phplrt\Parser\Grammar\Alternation([145, 148]),
        151 => new \Phplrt\Parser\Grammar\Lexeme('T_COMMA', false),
        152 => new \Phplrt\Parser\Grammar\Lexeme('T_SETTING_NOTE', false),
        153 => new \Phplrt\Parser\Grammar\Optional(151),
        154 => new \Phplrt\Parser\Grammar\Lexeme('T_BOOL_TRUE', true),
        155 => new \Phplrt\Parser\Grammar\Lexeme('T_BOOL_FALSE', true),
        156 => new \Phplrt\Parser\Grammar\Lexeme('T_WORD', true),
        157 => new \Phplrt\Parser\Grammar\Lexeme('T_QUOTED_STRING', true),
        158 => new \Phplrt\Parser\Grammar\Lexeme('T_EOL', false),
        0 => new \Phplrt\Parser\Grammar\Repetition(158, 0, INF)
    ],
    'reducers' => [
